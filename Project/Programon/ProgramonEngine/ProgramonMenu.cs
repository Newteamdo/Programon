...
namespace ProgramonEngine
{
    public class ProgramonMenu : IGuiItem
    {
        ...
        private TextField[] naamTextField { get; set; }
        ...
        public ProgramonMenu()
        {
            ...
            naamTextField = new TextField[amountOfProgramons];
        ...
        public ProgramonMenu(SpriteDrawer spritedrawer, Game game)
        {
            amountOfProgramons = 3;
        ...
        public void Draw(SpriteBatch spritebatch)
        {
            ...
            if (amountOfProgramons < 4)
            {
                for (int i = 0; i < amountOfProgramons; i++)
                {
                    ...
                    naamTextField[i].Draw(spritebatch);
                }
            }
        }
    }
